...
# this admin script out of the phproxy-plus directory. You can use a relative
...
OUT;
		...
		<div id="footer">
			...
			<div id="footer_bg">
				<p><a href="http://phproxy-plus.sourceforge.net/">PHProxy++</a> &copy; 2007-2012 PHProxy++. All rights reserved.</p>
			</div>
...
if ( ! $settingsLoaded ) {
	...
	$error->add('The settings file for PHProxy++ could not be found.
					 Please upload this tool into your root phproxy-plus directory.
...
if ( $user->isAdmin() ) {
	...
	$output->addNavigation('PHProxy++ Donations', 'http://phproxy-plus.sourceforge.net/donate.shtml');
	$output->addNavigation('BlockScript&reg;', $self.'?blockscript');
	$output->addNavigation('Support Forum', 'http://phproxy-plus.sourceforge.net/forum/');
...
OUT;
		...
		# Add footer links
		$output->addFooterLinks('PHProxy++ support forum at phproxy-plus.sourceforge.net', 'http://phproxy-plus.sourceforge.net/forum/');
