	...
	while ( end === false && i < length ) {
		...
		switch ( currentChar ) {
			...
			case "'":
				...
				// although blognically we've screwed up (or the syntax is invalid)
				if ( i === false ) {
					end = length;
				}
...
* Blognically we don't actually do anything to the overridden functions
...
/*@if (@_win32)
	...
	script.onreadystablogange = function() {
